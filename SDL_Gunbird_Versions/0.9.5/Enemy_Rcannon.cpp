...
{
	front.PushBack({ 588,233,16,57 });
	front.speed = 0.25f;

	r1.PushBack({ 608,233,16,57 });
	r1.speed = 0.25f;
	r2.PushBack({ 628,233,16,57 });
	r2.speed = 0.25f;
	r3.PushBack({ 650,233,16,57 });
	r3.speed = 0.25f;
	r4.PushBack({ 671,233,16,57 });
	r4.speed = 0.25f;
	r5.PushBack({ 694,233,16,57 });
	r5.speed = 0.25f;
	r6.PushBack({ 716,233,16,57 });
	r6.speed = 0.25f;
	r7.PushBack({ 740,233,16,57 });
	r7.speed = 0.25f;

	back.PushBack({ 763,233,16,57 });
	back.speed = 0.25f;
	//
	l1.PushBack({ 923,233,16,57 });
	l1.speed = 0.25f;
	l2.PushBack({ 899,233,16,57 });
	l2.speed = 0.25f;
	l3.PushBack({ 875,233,16,57 });
	l3.speed = 0.25f;
	l4.PushBack({ 851,233,16,57 });
	l4.speed = 0.25f;
	l5.PushBack({ 828,233,16,57 });
	l5.speed = 0.25f;
	l6.PushBack({ 806,233,16,57 });
	l6.speed = 0.25f;
	l7.PushBack({ 784,233,16,57 });
	l7.speed = 0.25f;
	...
	collider = App->collision->AddCollider({ 0, 0, 0, 0 }, COLLIDER_TYPE::COLLIDER_ENEMY, NULL, (Module*)App->enemies);
