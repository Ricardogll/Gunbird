...
bool ModuleParticles::Start()
{
	...
	laser_nang_0.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_1.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_2.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_3.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_4.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_5.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_6.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_7.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_8.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_9.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_10.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_11.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_12.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_13.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
	laser_nang_14.fx = App->audio->LoadWAV("assets/audio/sound/gunbird-056_Shoot_YungNang.wav");
...
bool ModuleParticles::CleanUp()
{
	...
	App->audio->UnloadWAV(laser_nang_0.fx);
	App->audio->UnloadWAV(laser_nang_1.fx);
	App->audio->UnloadWAV(laser_nang_2.fx);
	App->audio->UnloadWAV(laser_nang_3.fx);
	App->audio->UnloadWAV(laser_nang_4.fx);
	App->audio->UnloadWAV(laser_nang_5.fx);
	App->audio->UnloadWAV(laser_nang_6.fx);
	App->audio->UnloadWAV(laser_nang_7.fx);
	App->audio->UnloadWAV(laser_nang_8.fx);
	App->audio->UnloadWAV(laser_nang_9.fx);
	App->audio->UnloadWAV(laser_nang_10.fx);
	App->audio->UnloadWAV(laser_nang_11.fx);
	App->audio->UnloadWAV(laser_nang_12.fx);
	App->audio->UnloadWAV(laser_nang_13.fx);
	App->audio->UnloadWAV(laser_nang_14.fx);
