...
void Character_YuanNang::Move()
{
	...
	if (this->desactivateInput == false) {
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_D] == KEY_STATE::KEY_REPEAT || App->input->gamepad.DPAD_RIGHT == CONTROLLER_STATE::BUTTON_REPEAT) ||
		...
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_A] == KEY_STATE::KEY_REPEAT || App->input->gamepad.DPAD_LEFT == CONTROLLER_STATE::BUTTON_REPEAT) ||
		...
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_W] == KEY_STATE::KEY_REPEAT || App->input->gamepad.DPAD_UP == CONTROLLER_STATE::BUTTON_REPEAT) ||
		...
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_S] == KEY_STATE::KEY_REPEAT || App->input->gamepad.DPAD_DOWN == CONTROLLER_STATE::BUTTON_REPEAT) ||
