...
void Character_YuanNang::Move()
{
	...
	if (this->desactivateInput == false) {
		...
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_D] == KEY_STATE::KEY_REPEAT) ||
		...
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_A] == KEY_STATE::KEY_REPEAT) ||
		...
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_W] == KEY_STATE::KEY_REPEAT) ||
		...
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_S] == KEY_STATE::KEY_REPEAT) ||
		...
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_W] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_D] == KEY_STATE::KEY_REPEAT) ||
		...
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_W] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_A] == KEY_STATE::KEY_REPEAT) ||
		...
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_S] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_D] == KEY_STATE::KEY_REPEAT) ||
		...
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_S] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_A] == KEY_STATE::KEY_REPEAT) ||
		...
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_A] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_D] == KEY_STATE::KEY_REPEAT) ||
...
void Character_YuanNang::Laser() {
	if (this->desactivateInput == false) {
		if ((App->player->characters[0]->type == YUAN_NANG && App->input->keyboard[SDL_SCANCODE_LCTRL] == KEY_STATE::KEY_DOWN || (0 < time)) ||
