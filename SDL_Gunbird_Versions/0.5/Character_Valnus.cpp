...
void Character_Valnus::Move()
{
	...
	if (this->desactivateInput == false) {
		if ((App->player->characters[0]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_D] == KEY_STATE::KEY_REPEAT) ||
		...
		if ((App->player->characters[0]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_A] == KEY_STATE::KEY_REPEAT) ||
		...
		if ((App->player->characters[0]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_W] == KEY_STATE::KEY_REPEAT) ||
		...
		if ((App->player->characters[0]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_S] == KEY_STATE::KEY_REPEAT) ||
		...
		if ((App->player->characters[0]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_W] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_D] == KEY_STATE::KEY_REPEAT) ||
			(App->player->characters[1] != nullptr && App->player->characters[1]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_UP] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_RIGHT] == KEY_STATE::KEY_REPEAT))
			if (inmortal == false)
				animation = &right;
			else
				animation = &blit_right;

		if ((App->player->characters[0]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_W] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_A] == KEY_STATE::KEY_REPEAT) ||
			(App->player->characters[1] != nullptr && App->player->characters[1]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_UP] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_LEFT] == KEY_STATE::KEY_REPEAT))
			if (inmortal == false)
				animation = &left;
			else
				animation = &blit_left;

		if ((App->player->characters[0]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_S] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_D] == KEY_STATE::KEY_REPEAT) ||
			(App->player->characters[1] != nullptr && App->player->characters[1]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_DOWN] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_RIGHT] == KEY_STATE::KEY_REPEAT))
			if (inmortal == false)
				animation = &right;
			else
				animation = &blit_right;

		if ((App->player->characters[0]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_S] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_A] == KEY_STATE::KEY_REPEAT) ||
			(App->player->characters[1] != nullptr && App->player->characters[1]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_DOWN] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_LEFT] == KEY_STATE::KEY_REPEAT))
			if (inmortal == false)
				animation = &left;
			else
				animation = &blit_left;

		if ((App->player->characters[0]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_A] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_D] == KEY_STATE::KEY_REPEAT) ||
			(App->player->characters[1] != nullptr && App->player->characters[1]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_LEFT] == KEY_STATE::KEY_REPEAT && App->input->keyboard[SDL_SCANCODE_RIGHT] == KEY_STATE::KEY_REPEAT))
			if (inmortal == false)
				animation = &idle;
			else
				animation = &blit_idle;
...
void Character_Valnus::Laser() {
	if (this->desactivateInput == false) {
		if ((App->player->characters[0]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_LCTRL] == KEY_STATE::KEY_DOWN || (0 < time)) ||
			(App->player->characters[1] != nullptr && App->player->characters[1]->type == VALNUS && App->input->keyboard[SDL_SCANCODE_RCTRL] == KEY_STATE::KEY_DOWN || (0 < time))) {
			//LEVEL 0
			if (level == 0) {
				if (time == 0)
				{
