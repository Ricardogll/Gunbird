...
bool ModuleBackgroundCastle::Start()
{
	...
	App->enemies->AddEnemy(ENEMY_TYPES::RCANNON, _ROBOT, 93, 1133);
	App->enemies->AddEnemy(ENEMY_TYPES::RCANNON, _ROBOT, 129, 1133);
...
update_status ModuleBackgroundCastle::Update()
{
	...
	if (App->input->keyboard[SDL_SCANCODE_F] == KEY_STATE::KEY_DOWN)
		App->render->camera.y = (-1400 + SCREEN_HEIGHT) * SCREEN_SIZE; /////////////////////////////
