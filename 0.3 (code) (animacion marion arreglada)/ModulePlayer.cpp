...
ModulePlayer::ModulePlayer()
{
	...
	right2.PushBack({ 20, 246, 27, 47 });
	right2.PushBack({ 79, 248, 27, 47 });
	right2.PushBack({ 121, 247, 27, 46 });
	right2.PushBack({ 171, 248, 27, 46 });
	right2.speed = 0.08f;
...
update_status ModulePlayer::Update()
{
	...
	{
		App->particles->AddParticle(App->particles->laser, position.x + 9, position.y - 50); 
